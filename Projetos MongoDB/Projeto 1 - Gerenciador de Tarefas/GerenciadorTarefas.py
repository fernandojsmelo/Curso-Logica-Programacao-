...
class GerenciadorTarefasApp:
    ...
    def __init__(self, janela):
        ...
        # largura como 950 pixeis e altura como 700 pixeis.
        ...
        # Cria uma instância de Style do módulo ttk para customizer a
        ...
        # a altura das linhas como 25 'píxeis', o fundo dos
        ...
        # - padx e pady adicionam um espaçamento externo de 5 píxeis em
        ...
        # Entry é um widget que permite ao utilizador inserir uma linha de texto.
        ...
        # Este rótulo serve como um indicativo visual para o utilizador sobre o
        ...
        #   o útil para manter o alinhamento visual com o rótulo do título acima.
        # - padx e pady definem o espaçamento externo de 5 píxeis, ajudando a
        ...
        # Este rótulo serve para indicar ao utilizador onde
        ...
        # - sticky='e' alinha o rótulo à direita dentro da sua célula grid,
        # ajudando na organização e alinhamento visual com outros rótulos.
        # - padx e pady adicionam um espaçamento externo de 5 píxeis
        ...
        # valor do status escolhido pelo utilizador.
        self.var_status = tk.StringVar()

        # Criação de um ComboBox para permitir ao utilizador selecionar um
        # status para a tarefa.
        # Um ComboBox é um widget que combina uma caixa de listagem com uma
        # caixa de entrada, permitindo seleções num conjunto definido.
        ...
        # ComboBox alinhe-se ao padrão, centralizar na célula.
        ...
        # sempre selecionado, evitando erros de utilizador ao esquecer
        ...
        # na janela, posicionando-o conforme as necessidades de layout.
        # - pady=10 adiciona um espaçamento vertical de 10 píxeis acima e
        ...
        # usado pelo utilizador para adicionar novas tarefas ao sistema.
        ...
        # espaçamentos de 10 pixeis horizontalmente e 5 pixeis verticalmente.
        ...
        # Cria o botão "Excluir Tarefa", que permite ao utilizador remover uma tarefa existente.
        ...
        # 'pady=10' adiciona um espaçamento vertical de 10 pixeis
        ...
        # para o utilizador sobre a funcionalidade do campo associado.
        rotulo_filtro = tk.Label(quadro_filtro,

                                 # Texto exibido no rótulo, informando claramente o propósito do
        ...
        # 'padx=5' adiciona um espaçamento horizontal de 5 pixeis
        # ao lado do rótulo,
        # ajudando a separar visualmente o rótulo de outros widgets
        # ou bordas do quadro.
        rotulo_filtro.grid(row=0, column=0, padx=5)

        # Criação de uma variável StringVar para armazenar e 'gerir' o
        ...
        self.combo_filtro.grid(row=0,
                               ...
                               # 'padx=5' adiciona um espaçamento horizontal de 5 pixeis, garantindo um
        ...
        # Criação de um quadro para conter o Treeview, usado para listar as tarefas.
        ...
        # 'pady=20' adiciona um espaçamento vertical de 20 pixeis
        # acima e abaixo do quadro,
        ...
        # A barra de rolagem permite ao utilizador navegar verticalmente pela
        ...
        # A largura é definida como 220 pixeis para garantir que o
        ...
        # A largura é ajustada para 480 pixeis, sendo a maior entre as
        # colunas, pois a descrição das tarefas geralmente contém mais texto.
        # Isso assegura que a maioria do conteúdo fique visível sem
        ...
        # A largura é definida como 120 pixeis, pois o conteúdo esperado nesta
        ...
        # O evento "TreeviewSelect" é disparado quando o utilizador
        ...
        # - pady=10 adiciona um espaçamento vertical de 10 pixeis acima e abaixo do Treeview.
        # - padx=10 adiciona um espaçamento horizontal de 10 pixeis em ambos os lados.
    ...
    def adicionar_tarefa(self):
        ...
        # ao utilizador usando o messagebox.
        if not titulo:
        ...
        # Limpa os campos de entrada na 'interface' para que o utilizador possa
        # adicionar uma nova tarefa sem interferência de dados anteriores.
        self.limpar_campos_entrada()

        # Exibe uma mensagem de sucesso ao utilizador indicando que a
    ...
    def atualizar_tarefa(self):
        ...
        # 'get()' recupera o texto digitado pelo utilizador, enquanto 'strip()'
        ...
        # utilizador e interrompe a execução do método.
        if not titulo:
            messagebox.showwarning("Aviso", "O título da tarefa não pode estar vazio.")  # Exibe um alerta.
        ...
        # Isso prepara os campos para que o utilizador possa realizar outras
    ...
    def excluir_tarefa(self):
        ...
        if not self.id_tarefa_selecionada:
            # Exibe uma mensagem de aviso ao utilizador informando que
        ...
        # Retorna True se o utilizador clicar em "Sim" e False se clicar em "Não".
        confirmar = messagebox.askyesno("Confirmar Exclusão", "Deseja realmente excluir esta tarefa?")

        # Verifica se o utilizador confirmou a exclusão.
        if confirmar:
            ...
            # Exibe uma mensagem de sucesso informando ao utilizador que a tarefa foi excluída.
    ...
    def ao_selecionar_tarefa(self, event):
        ...
        permitindo que o utilizador visualize ou edite as informações.
        """
...
# será usada como o container principal da 'interface' gráfica.
...
# aberta e responsiva a interações do utilizador,
