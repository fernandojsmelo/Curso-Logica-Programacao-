...
Vamos implementar uma função recursiva em JavaScript para calcular o fatorial de um 
número.
...
function fatorial(n) {
  // A função inicia verificando se o valor de `n` é igual a 0. Essa é a condição de
  // parada da recursão.
  ...
  // Aqui, `fatorial(n - 1)` chama a função `fatorial` novamente, passando `n - 1`
  // como argumento.
  // Essa chamada recursiva continua até que o argumento da função seja 0, ponto em
  // que a recursão começa a retornar.
