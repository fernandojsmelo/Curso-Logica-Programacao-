...
Solicitar ao usuário que insira as notas do aluno em três matérias: 
Matemática, Física e Química.
Calcular a média das notas do aluno.
Exibir todas as informações fornecidas pelo usuário, incluindo nome, 
idade, curso, notas em cada matéria e média das notas.
Certifique-se de que o programa esteja devidamente estruturado, 
utilizando objetos para representar as informações do aluno e funções 
para calcular a média das notas e exibir as informações.*/

// Importa o módulo 'readline' do Node.js, que permite a leitura de
// dados do terminal.
const readline = require("readline");

// Cria uma interface de leitura e escrita usando o módulo 'readline'.
// Especifica 'process.stdin' como entrada (input) para capturar o que
// é digitado pelo usuário.
// Especifica 'process.stdout' como saída (output) para exibir
...
function solicitarInformacao(pergunta) {
  return new Promise((resolve, reject) => {
    ...
    // Quando o usuário responde, a função resolve a Promise com a
    // resposta.
...
// Função assíncrona autoinvocável para realizar a interação com o
// usuário.
(async () => {
  // Solicita o nome do aluno utilizando a função 'solicitarInformacao'
  // e armazena no objeto 'aluno'.
  aluno.nome = await solicitarInformacao("Digite o nome do aluno: ");

  // Solicita a idade, converte para inteiro e armazena no objeto
  // 'aluno'.
  ...
  // Solicita a nota de Matemática, converte para float e armazena no
  // subobjeto 'notas'.
  ...
  // Declara uma função chamada 'calcularMedia' que recebe um
  // parâmetro 'aluno'.
  // Esta função é responsável por calcular a média aritmética das
  // notas do aluno.
  function calcularMedia(aluno) {
    ...
    // propriedade dentro do objeto 'notas' que faz parte do objeto
    // 'aluno'.
  ...
  // Utiliza o console.log para exibir informações sobre o aluno
  ...
  // Novamente, utiliza um laço 'for...in' para iterar sobre cada nota
  // no objeto 'notas'.
  ...
  // corretamente, liberando recursos que a interface pode estar
  // utilizando.
  rl.close();
})();
