...
// Chamando a função com dois argumentos: 'Alice' para 'nome' e
// 'Bom dia' para 'mensagem'
let saudacaoParaAlice = saudacaoPersonalizada("Alice", "Bom dia");

// Chamando a função novamente com diferentes argumentos: 'Bob' e
// 'Boa noite'
...
// Declaração da função com dois parâmetros: 'valorTotal' e
// 'porcentagemDesconto'
...
// 10% de desconto em uma compra de R$200
let valorCompra1 = calcularDesconto(200, 10);

// 15% de desconto em uma compra de R$500
let valorCompra2 = calcularDesconto(500, 15);

// Exibindo os valores finais após descontos no console

// Saída esperada: Valor final após desconto: R$180
console.log(`Valor final após desconto: R$${valorCompra1}`);

// Saída esperada: Valor final após desconto: R$425
console.log(`Valor final após desconto: R$${valorCompra2}`);
