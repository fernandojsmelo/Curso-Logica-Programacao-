...
// Define a classe 'Pessoa' que é uma estrutura para criar objetos que
// representam pessoas.
class Pessoa {
  // Construtor da classe é chamado automaticamente ao criar uma nova
  // instância.
  // 'nome' e 'idade' são parâmetros que inicializam as propriedades
  // do objeto.
  ...
  // Método 'exibirDetalhes' é usado para imprimir detalhes do objeto
  // pessoa.
  // Este método não aceita parâmetros e usa as propriedades do
  // objeto para mostrar informações no console.
  exibirDetalhes() {
    console.log(`Nome: ${this.nome}, Idade: ${this.idade}`);
  }

  // Método 'cumprimentar' permite ao objeto pessoa emitir uma
  // saudação.
  // Este método também não aceita parâmetros e utiliza a propriedade
  // 'nome' para a saudação.
  cumprimentar() {
    console.log(`Olá, eu sou ${this.nome}!`);
  }
}

// Cria uma instância da classe 'Pessoa' chamada 'pessoa1' com nome
// 'João' e idade 30.
const pessoa1 = new Pessoa("João", 30);

// Utiliza o método 'exibirDetalhes' para mostrar o nome e a idade de
// 'pessoa1' no console.
...
// Repete o processo para outras quatro instâncias, cada uma com nomes
// e idades diferentes:
...
Métodos
Os métodos são funções que estão dentro de uma classe. Eles definem o 
que um objeto dessa classe pode fazer. No exemplo, exibirDetalhes() e 
...
Criando Objetos: Depois, criamos objetos (instâncias) usando a 
palavra-chave 
new e passando os valores específicos (como nome e idade) para o 
construtor.

Usando Métodos: Em seguida, utilizamos os métodos definidos na classe 
para fazer algo útil, como exibir informações do objeto ou cumprimentar.
...
class Pessoa {
    ...
    constructor(nome, idade) {
        ...
        // Atribui o valor do parâmetro 'nome' à propriedade 'nome' do 
        // novo objeto.
        this.nome = nome;
  
        // 'this.idade' refere-se à propriedade 'idade' do objeto que 
        // será criado.
        // Atribui o valor do parâmetro 'idade' à propriedade 'idade' 
        // do novo objeto.
        this.idade = idade;
    ...
    // Este método não recebe parâmetros e é usado para imprimir 
    // informações sobre o objeto.
    exibirDetalhes() {

        // Utiliza 'console.log' para imprimir no console os valores das
        // propriedades 'nome' e 'idade'.
        // Usa template strings para incluir as propriedades do objeto 
        // dentro do texto.
        console.log(`Nome: ${this.nome}, Idade: ${this.idade}`);
    ...
    cumprimentar() {
        ...
        // Utiliza 'console.log' para imprimir uma saudação que inclui o 
        // nome do objeto.
        // Usa template strings para incorporar a propriedade 'nome' do 
        // objeto no texto da saudação.
        console.log(`Olá, eu sou ${this.nome}!`);
...
// Cria uma nova instância da classe 'Pessoa', passando 'João' como
// nome e '30' como idade.
// 'pessoa6' é o nome da variável que armazena a referência para o
// novo objeto 'Pessoa'.
