...
public class Pesquisa extends JFrame {
	...
	//Metodo para carregar as informações
	public void carregarItens() {
		...
		tabelaAgenda.getColumnModel().getColumn(0).
				setPreferredWidth(50); //Id
		tabelaAgenda.getColumnModel().getColumn(1).
				setPreferredWidth(200); //Nome
		tabelaAgenda.getColumnModel().getColumn(2).
				setPreferredWidth(200); //Telefone
		tabelaAgenda.getColumnModel().getColumn(3).
				setPreferredWidth(300); //Email
		tabelaAgenda.getColumnModel().getColumn(4).
				setPreferredWidth(200); //Endereco
		tabelaAgenda.getColumnModel().getColumn(5).
				setPreferredWidth(150); //Nascimento
		tabelaAgenda.getColumnModel().getColumn(6).
				setPreferredWidth(100); //Sexo
