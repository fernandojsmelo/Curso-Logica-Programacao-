...
public class Jogo4x4_Activity extends AppCompatActivity {
    ...
    Integer[] arrayPosicoesImagens = {101, 102, 103, 104, 105, 106, 107, 108, 201, 202, 203, 204, 205, 206, 207, 208};
    ...
    private void configuracoesIniciais(){
        ...
        imagem_L1xC1 = findViewById(R.id.imgMatriz4x4_L1xC1);
        imagem_L1xC2 = findViewById(R.id.imgMatriz4x4_L1xC2);
        imagem_L1xC3 = findViewById(R.id.imgMatriz4x4_L1xC3);
        imagem_L1xC4 = findViewById(R.id.imgMatriz4x4_L1xC4);


        imagem_L2xC1 = findViewById(R.id.imgMatriz4x4_L2xC1);
        imagem_L2xC2 = findViewById(R.id.imgMatriz4x4_L2xC2);
        imagem_L2xC3 = findViewById(R.id.imgMatriz4x4_L2xC3);
        imagem_L2xC4 = findViewById(R.id.imgMatriz4x4_L2xC4);

        imagem_L3xC1 = findViewById(R.id.imgMatriz4x4_L3xC1);
        imagem_L3xC2 = findViewById(R.id.imgMatriz4x4_L3xC2);
        imagem_L3xC3 = findViewById(R.id.imgMatriz4x4_L3xC3);
        imagem_L3xC4 = findViewById(R.id.imgMatriz4x4_L3xC4);

        imagem_L4xC1 = findViewById(R.id.imgMatriz4x4_L4xC1);
        imagem_L4xC2 = findViewById(R.id.imgMatriz4x4_L4xC2);
        imagem_L4xC3 = findViewById(R.id.imgMatriz4x4_L4xC3);
        imagem_L4xC4 = findViewById(R.id.imgMatriz4x4_L4xC4);

        //Começa a contar o tempo com 100 segundos
        contaTempo = 100;
        ...
        imagem_L4xC1.setImageResource(R.drawable.ic_close_preto_24dp);
        imagem_L4xC2.setImageResource(R.drawable.ic_close_preto_24dp);
        imagem_L4xC3.setImageResource(R.drawable.ic_close_preto_24dp);
        imagem_L4xC4.setImageResource(R.drawable.ic_close_preto_24dp);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (contaTempo > 0){
                            ...
                            Toast.makeText(getApplication(), "Seu tempo acabou! Até a próxima!", Toast.LENGTH_LONG).show();
                            finish();
