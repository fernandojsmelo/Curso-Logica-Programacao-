...
public class Jogo3x2_Activity extends AppCompatActivity {
    ...
    ImageView imagem_L3xC1,imagem_L3xC2;
    Button btnParar;
    Button btnRecomecar;
    ...
    Integer[] arrayPosicoesImagens = {101, 102, 103, 201, 202, 203};
    ...
    private void configuracoesIniciais(){
        ...
        imagem_L1xC1 = findViewById(R.id.imgMatriz3x2_L1xC1);
        imagem_L1xC2 = findViewById(R.id.imgMatriz3x2_L1xC2);
        imagem_L2xC1 = findViewById(R.id.imgMatriz3x2_L2xC1);
        imagem_L2xC2 = findViewById(R.id.imgMatriz3x2_L2xC2);
        imagem_L3xC1 = findViewById(R.id.imgMatriz3x2_L3xC1);
        imagem_L3xC2 = findViewById(R.id.imgMatriz3x2_L3xC2);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (contaTempo > 0){
                            ...
                            Toast.makeText(Jogo3x2_Activity.this, "Seu tempo acabou! Até a próxima!", Toast.LENGTH_LONG).show();
                            finish();
