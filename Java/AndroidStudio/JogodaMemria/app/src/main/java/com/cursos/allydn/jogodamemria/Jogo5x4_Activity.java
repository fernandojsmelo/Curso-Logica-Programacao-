...
public class Jogo5x4_Activity extends AppCompatActivity {
    ...
    private void configuracoesIniciais(){
        ...
        imagem_L5xC1.setImageResource(R.drawable.ic_close_preto_24dp);
        imagem_L5xC2.setImageResource(R.drawable.ic_close_preto_24dp);
        imagem_L5xC3.setImageResource(R.drawable.ic_close_preto_24dp);
        imagem_L5xC4.setImageResource(R.drawable.ic_close_preto_24dp);
